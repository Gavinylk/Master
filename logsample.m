...
Ydata = [0, nw-1];
Size = [nw, nr];
logarr = imtransform(arr, t, 'bicubic', 'Udata', Udata, 'Vdata', Vdata, 'Xdata', Xdata, 'Ydata', Ydata, 'Size', Size);
%logarr = imwarp(arr, t, 'Udata', Udata, 'Vdata', Vdata, 'Xdata', Xdata, 'Ydata', Ydata, 'Size', Size);
end